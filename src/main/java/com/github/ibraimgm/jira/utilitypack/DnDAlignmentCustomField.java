...
public class DnDAlignmentCustomField extends AbstractSingleFieldType<String>
{
                                                   ...
                                                   final FieldLayoutItem fieldLayoutItem)
  {
    ...
    // call the default implementation and get out if we don't have a current
    // issue
    final Map<String, Object> map = super.getVelocityParameters(issue, field,
                                                                fieldLayoutItem);

    if (issue == null) return map;
   ...
   * 
   * @see com.atlassian.jira.issue.customfields.impl.AbstractSingleFieldType#
   * getDbValueFromObject(java .lang.Object)
   */
  @Override
  @Nullable
   ...
   * 
   * @see com.atlassian.jira.issue.customfields.impl.AbstractSingleFieldType#
   * getObjectFromDbValue(java .lang.Object)
   */
  @Override
  @Nullable
